...
<div class="l-sub-section" markdown="1">
  ...
  supported by a [ControlValueAccessor](/angular/api/angular/ControlValueAccessor-class.html)
...
<div class="l-sub-section" markdown="1">
  ...
  and `odd` in the [NgFor API reference](/angular/api/angular/NgFor-class.html).
</div>
...
[NgForm](/angular/api/angular/NgForm-class.html "API: NgForm")
