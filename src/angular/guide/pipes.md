...
[pipe operator](./template-syntax.html#pipe) ( | ) to the [Date pipe](/angular/api/angular.common/DatePipe-class.html)
...
<div class="l-sub-section" markdown="1">
  Read more about the `DatePipe` format options in the [Date Pipe](/angular/api/angular.common/DatePipe-class.html)
  API Reference page.
</div>
...
<div class="callout is-helpful" markdown="1">
  ...
  The [JsonPipe](/angular/api/angular.common/JsonPipe-class.html)
