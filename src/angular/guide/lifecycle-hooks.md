...
[SimpleChange](/angular/api/angular.core/SimpleChange-class.html) object holding the current and previous property values.
...
[@ViewChild](/angular/api/angular.core/ViewChild-class.html).
